...
public class ImageController {
    ...
    @RequestMapping(
            value = {"/img/kategoria/{category}/{nameUrl}", "/img/kategoria/{category}/{nameUrl}/{imageName}"},
            method = RequestMethod.GET,
            produces = MediaType.IMAGE_JPEG_VALUE)
    public ResponseEntity<InputStreamResource> getImageLink(@PathVariable String category, @PathVariable String nameUrl, @PathVariable(required = false) String imageName) throws IOException {
    ...
    @RequestMapping(value="/imgs/kategoria/{category}/{productNameUrl}", method = RequestMethod.GET)
